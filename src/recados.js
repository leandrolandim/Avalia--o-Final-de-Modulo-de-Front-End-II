...
function salvarRecado() {
    const descricao = form2.descricao.value;
    const detalhe = form2.detalhamento.value;
    const mensagem = {
        descricao,
        detalhe,
    };
...
function editarMensagem(index) {
    form2.descricao.value = user.mensagens[index].descricao;
    form2.detalhamento.value = user.mensagens[index].detalhe;
    editar = true;
    indexEditar = index;
}
function sair() {
